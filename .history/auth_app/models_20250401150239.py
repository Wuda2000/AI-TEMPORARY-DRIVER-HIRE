...
class DriverApplication(models.Model):
    ...
    license_number = models.CharField(max_length=50, unique=True, default="UNKNOWN")  # Default to "UNKNOWN"
    cover_letter = models.FileField(upload_to="documents/", default='default_cover_letter.pdf', blank=True)  # Added cover letter field
    ...
    good_conduct = models.FileField(upload_to='good_conduct_certificates/', null=True, blank=True)  # Ensure this field is defined 
    applied_at = models.DateTimeField(auto_now_add=True)
    created_at = models.DateTimeField(default=now)
