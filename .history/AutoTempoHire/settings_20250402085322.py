...
EMAIL_USE_TLS = env.bool('EMAIL_USE_TLS', default=True)  # Default to True if not set
EMAIL_USE_SSL = env.bool('EMAIL_USE_SSL', default=False)  # Default to False if not set

# You may want to ensure only one of TLS or SSL is True
if EMAIL_USE_TLS and EMAIL_USE_SSL:
    raise ValueError("You cannot use both TLS and SSL at the same time.")
